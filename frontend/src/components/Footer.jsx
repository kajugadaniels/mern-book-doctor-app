            ...
            <div className="container">
                <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
                    <div>
                        ...
                        <p className="text-[14px] leading-7 font-[400]">
                            ©️{year}
                        </p>
                    ...
                    <div>
                        <h2 className="text-[16px] leading-[30px] font-[700] mb-6 text-headingColor">
                            Quick Links
                        </h2>
                        <ul>
                            {quickLinks01.map((item, index) => (
                                <li key={index} className="mb-4">
                                    <Link
                                        to={item.path}
                                        className="text-[14px] leading-7 font-[500] text-textColor"
                                    >
                                        {item.display}
                                    </Link>
                                </li>
