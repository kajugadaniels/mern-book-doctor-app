        ...
        <>
            <div className="p-3 lg:p-5 mb-5 rounded-[12px] border border-solid border-[#D9DCE2] cursor-pointer">
                <div
                    ...
                    onClick={faqToggle}
                >
                    <h4 className="text-[14px] leading-7 lg:text-[16px] font-bold lg:leading-8 text-headingColor">
                        {question}
                    </h4>
                ...
                {isOpen && (
                    <div className="mt-4">
                        <p className="text-[12px] leading-6 lh:text-[14px] lg:leading-7 font-[400]">
                            {content}
                        </p>
                    </div>
                )}
