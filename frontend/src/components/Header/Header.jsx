                            ...
                            {navLinks.map((item, index) => (
                                <li key={index}>
                                    <NavLink
                                        ...
                                        className={(navClass) =>
                                            navClass.isActive
                                                ? "text-primaryColor text-16px leading-7 font-black"
                        ...
                        <div className="hidden">
                            <Link to="/">
                                <figure className="w-35px h-35px rounded-full">
                                    <img src='/images/avatar-icon.png' alt="user" />
                                </figure>
                            </Link>
                        </div>
                        <Link to="login">
                            <button className="bg-primaryColor py-2 px-10 text-white font-[800] h-[40px] flex items-center justify-center rounded-[50px]">
                                Login
                            </button>
                        </Link>
