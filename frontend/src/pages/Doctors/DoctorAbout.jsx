const DoctorAbout = ({ doctor }) => {
    return (
        <div>
            <div>
                <h3 className="text-[16px] leading-[30px] text-headingColor font-semibold flex items-center gap-2">
                    About of{" "}
                    <span className="text-irisBlueColor font-bold text-[16px] leading-9">
                        {doctor.name}
                    </span>
                </h3>
            ...
            <div className="mt-12">
                <h3 className="text-[16px] leading-[30px] text-headingColor font-semibold">
                    Education
                </h3>
